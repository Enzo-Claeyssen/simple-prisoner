...
class Meeting(Evaluator):
    ...
    def run(self):
        ...
        self.s1.finalUpdate(self.s1_score, self.s2_score, self.s1_rounds, self.s2_rounds)
        self.s2.finalUpdate(self.s1_score, self.s2_score, self.s1_rounds, self.s2_rounds)
